...
import static com.wavesplatform.wavesj.json.ExchangeTransactionTestData.DATA_SRV_FORMAT;
import static com.wavesplatform.wavesj.json.ExchangeTransactionTestData.NODE_FORMAT;
...
public class ExchangeTransactionDeserTest extends TransactionDeserTest {
    ...
    @Test
    public void dataSrvFormatParsingCompatibilityTest() throws Exception {
        ExchangeTransaction txNodeApi = (ExchangeTransaction) mapper.readValue(NODE_FORMAT, Transaction.class);
        Assert.assertNotNull(txNodeApi);

        ExchangeTransaction txDataSrv = (ExchangeTransaction) dsMapper.readValue(DATA_SRV_FORMAT, Transaction.class);
